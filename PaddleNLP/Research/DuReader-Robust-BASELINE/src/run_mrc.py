...
model_g.add_arg("ernie_config",         str,  None,           "Path to the json file for ernie model config.")
...
data_g.add_arg("predict_file",              str,   None,  "SQuAD json for predictions. E.g. dev-v1.1.json or test-v1.1.json.", nargs='+')
...
def predict(test_exe, test_program, test_data_loader, fetch_list, processor, prefix=''):
